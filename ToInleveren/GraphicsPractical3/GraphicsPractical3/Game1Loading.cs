...
public partial class Game1 : Microsoft.Xna.Framework.Game
{
    ...
    protected override void Initialize()
    {
        ...
        this.camera = new Camera(new Vector3(15, 38, 45), new Vector3(0, 0, 0), new Vector3(0, 1, 0));
    ...
    protected override void LoadContent()
    {
        ...
        lights[0] = new MovingLight(new Vector3(0, 13, 0), 0, 0, 0.0f, Color.LightGoldenrodYellow.ToVector4());// * 250);
        lights[1] = new MovingLight(new Vector3(0, 13, 0), 25, .25f, 0.1f, Color.Green.ToVector4());
        lights[2] = new MovingLight(new Vector3(0, 13, 0), 6, .5f, 0.15f, Color.Red.ToVector4());
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            boxTransform.Add(Matrix.CreateScale(2.0f, 20.0f, 2.0f) * Matrix.CreateTranslation( 5 + 4.5f * i, 5 * i, -15 + 0.5f * i));
        }
